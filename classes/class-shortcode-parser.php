    ...
    class Shortcode_Parser{
        ...
        private function load_embed_datapage(){
            if(empty($this->url) || empty($this->appkey)){
                ...
                .'<div id="cxkg"><a href="'.esc_attr($this->url).'/dp.asp?AppKey='.esc_attr($this->appkey).'">Click here</a> to load this Caspio <a href="http://www.caspio.com" title="Online Database">Online Database</a>.</div>';
            }
        }
